...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride = 1, downsample = None, radix = 1, cardinality = 1, base_width = 64,
                 reduce_first = 1, dilation = 1, first_dilation = None, norm_layer = nn.BatchNorm2d, act_layer = nn.ReLU,
                 use_pooling = False, pool_type = 'avg', pool_first = False, rectified_conv = False, rectify_avg = False,
                 drop_block = None):
        ...
        if radix > 1:
            self.conv2 = SplAtConv2d(
                first_planes, width, kernel_size = 3, stride = stride, padding = first_dilation, dilation = first_dilation,
                groups = cardinality, bias = False, radix = radix, rectify = rectified_conv, rectify_avg = rectify_avg,
...
def resnest50(pretrained = False, num_classes = 1000, in_chans = 3, **kwargs):
    stem_type, act_layer, avg_down = 'deep', nn.ReLU, True
    ...
    model = ResNet(Bottleneck, [3, 4, 6, 3], num_classes = num_classes, in_chans = in_chans,
                   cardinality = 1, base_width = 64, stem_width = 32, stem_type = stem_type,
                   act_layer = act_layer, avg_down = avg_down, block_args = block_args, **kwargs)
...
def resnest101(pretrained = False, num_classes = 1000, in_chans = 3, **kwargs):
    ...
    model = ResNet(Bottleneck, [3, 4, 23, 3], num_classes = num_classes, in_chans = in_chans,
                   cardinality = 1, base_width = 64, stem_width = 64, stem_type = stem_type,
                   act_layer = act_layer, avg_down = avg_down, block_args = block_args, **kwargs)
...
def resnest200(pretrained = False, num_classes = 1000, in_chans = 3, **kwargs):
    ...
    model = ResNet(Bottleneck, [3, 24, 36, 3], num_classes = num_classes, in_chans = in_chans,
                   cardinality = 1, base_width = 64, stem_width = 64, stem_type = stem_type,
                   act_layer = act_layer, avg_down = avg_down, block_args = block_args, **kwargs)
...
def resnest269(pretrained = False, num_classes = 1000, in_chans = 3, **kwargs):
    ...
    model = ResNet(Bottleneck, [3, 30, 48, 8], num_classes = num_classes, in_chans = in_chans,
                   cardinality = 1, base_width = 64, stem_width = 64, stem_type = stem_type,
                   act_layer = act_layer, avg_down = avg_down, block_args = block_args, **kwargs)
