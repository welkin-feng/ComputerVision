...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels_reduced, stride = 1):
        """ Constructor for ResNet_Block """
        super().__init__()
        out_channels = out_channels_reduced * self.expansion
        self.conv = nn.Sequential(
            nn.Conv2d(in_channels, out_channels_reduced, 3, stride, 1),
            nn.BatchNorm2d(out_channels_reduced),
            nn.ReLU(inplace = True),
            nn.Conv2d(out_channels_reduced, out_channels, 3, 1, 1),
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_channels, out_channels_reduced, stride = 1):
        ...
        self.conv = nn.Sequential(
            ...
            nn.BatchNorm2d(out_channels_reduced),
            nn.ReLU(inplace = True),
            nn.Conv2d(out_channels_reduced, out_channels_reduced, 3, padding = 1),
            nn.BatchNorm2d(out_channels_reduced),
            nn.ReLU(inplace = True),
